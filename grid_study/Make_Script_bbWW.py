...
def generate_shell_scripts(args):
    ...
    base_cmd_pc = (
        ...
        "--base_dir /pscratch/sd/t/tihsu/database/Grid_Study_CMS_OpenData_bbWW_HWW/data "
        "--yaml_path config/sample_bbWW.yaml "
        "--mX {mX} --mY {mY} "
        "--out_dir /pscratch/sd/t/tihsu/database/Grid_Study_CMS_OpenData_bbWW_HWW/method/ "
